...
_HERE = Path(__file__).resolve().parent          # mysql_qa/
sys.path.insert(0, str(_HERE))                   # db、cache、retrieval 在这里
sys.path.insert(1, str(_HERE.parent))            # base 在 Itcast_qa_system/
os.chdir(_HERE.parent)                           # 课程约定的运行根目录
